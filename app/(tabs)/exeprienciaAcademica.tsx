        ...
        <View style={styles.bioContainer}>
          <View style={styles.bio}>
            <Text style={styles.text}>
              Participei de uma pesquisa (PIBIC) pela primeira vez no ano
              passado, ela foca na classificação de câncer de mama através de
              processamento de imagens e aplicação dos dados em redes neurais.
              Nesse novo ciclo do PIBIC vou ingressar em novo projeto, essa
              pesquisa estuda algorítmos evolucionarios para otimização. Faço
              parte também da Maratona de Programação, participando anualmente
              de competições e praticando semanalmente para melhorar minhas
              habilidades. Estou sempre em busca de oportunidades para evoluir
              tecnicamente e aprender novas tecnologias.
            </Text>
          </View>
        </View>
      </View>
